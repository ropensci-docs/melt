...
inherits from
[GLM](https://docs.ropensci.org/melt/reference/GLM-class.md) class.
...
#> Extends: 
#> Class "GLM", directly
#> Class "LM", by class "GLM", distance 2
#> Class "CEL", by class "GLM", distance 3
#> Class "EL", by class "GLM", distance 4
```
