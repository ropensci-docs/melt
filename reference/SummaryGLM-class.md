...
[GLM](https://docs.ropensci.org/melt/reference/GLM-class.md) objects. It
inherits from
[SummaryLM](https://docs.ropensci.org/melt/reference/SummaryLM-class.md)
class.
